...
//! 2. [`Regulator::export`](noos::Regulator::export) snapshots the
//!    learned [`CorrectionPattern`](noos::CorrectionPattern) to a
//!    serialisable [`RegulatorState`](noos::RegulatorState).
//! 3. The snapshot round-trips through `serde_json` — simulating a
//!    process restart / next session.
//! 4. [`Regulator::import`](noos::Regulator::import) restores the
...
//! [`build_topic_cluster`](noos::cognition). After the first three
